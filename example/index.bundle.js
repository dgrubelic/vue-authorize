...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* unused harmony export camelCase */
/* unused harmony export isUndefined */
/* unused harmony export isDefined */
/* harmony export (immutable) */ __webpack_exports__["c"] = isObject;
/* unused harmony export isBlankObject */
...
/* harmony export (immutable) */ __webpack_exports__["f"] = isPromise;
/* unused harmony export isWindow */
/* unused harmony export getPrototypeOf */
/* harmony export (immutable) */ __webpack_exports__["a"] = objectExtend;
/* harmony export (immutable) */ __webpack_exports__["b"] = forEach;
/* unused harmony export joinUrl */
/* unused harmony export getFullUrlPath */
...
function decodeBase64(str) {
  ...
  let cb_btou = function (cccc) {
    switch (cccc.length) {
      case 4:
        let cp = (0x07 & cccc.charCodeAt(0)) << 18 | (0x3f & cccc.charCodeAt(1)) << 12 | (0x3f & cccc.charCodeAt(2)) << 6 | 0x3f & cccc.charCodeAt(3);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (immutable) */ __webpack_exports__["g"] = camelCase;
/* unused harmony export isUndefined */
/* unused harmony export isDefined */
/* harmony export (immutable) */ __webpack_exports__["c"] = isObject;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = objectExtend;
/* harmony export (immutable) */ __webpack_exports__["f"] = joinUrl;
/* harmony export (immutable) */ __webpack_exports__["h"] = getFullUrlPath;
/* harmony export (immutable) */ __webpack_exports__["i"] = parseQueryString;
/* harmony export (immutable) */ __webpack_exports__["e"] = decodeBase64;
if (typeof Object.assign != 'function') {
  Object.assign = function(target, varArgs) {
    'use strict';
    if (target == null) {
...
__WEBPACK_IMPORTED_MODULE_0_promise_polyfill___default.a.any = function (arrayOfPromises) {
  if (!arrayOfPromises || !(arrayOfPromises instanceof Array)) {
    throw new Error('Must pass Promise.any an array');
  }

  if (arrayOfPromises.length === 0) {
    return __WEBPACK_IMPORTED_MODULE_0_promise_polyfill___default.a.resolve([]);
  }
  ...
  return __WEBPACK_IMPORTED_MODULE_0_promise_polyfill___default.a.all(resolvingPromises).then(function (results) {
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_promise_polyfill___default.a);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__promise_js__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__authorize_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__directive_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component_js__ = __webpack_require__(20);
/* unused harmony reexport VueAuthorize */
...
function plugin(Vue, options) {
  ...
  Vue.directive('isAuthorized', __WEBPACK_IMPORTED_MODULE_2__directive_js__["a" /* default */]);
  Vue.component('isAuthorized', __WEBPACK_IMPORTED_MODULE_3__component_js__["a" /* default */]);
    ...
    $authorize: {
      get() {
        if (!vueAuthorizeInstance) {
          ...
          vueAuthorizeInstance = new __WEBPACK_IMPORTED_MODULE_1__authorize_js__["a" /* default */](this.$auth, options);
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__promise_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__auth_js__ = __webpack_require__(28);
    ...
    $auth: {
      get() {
        if (!vueAuthInstance) {
          ...
          vueAuthInstance = new __WEBPACK_IMPORTED_MODULE_2__auth_js__["a" /* default */](this.$http, options)
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_authenticate__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_index_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__acl_config_js__ = __webpack_require__(11);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_3_vue_authenticate__["a" /* default */]);
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_4__src_index_js__["a" /* default */], __WEBPACK_IMPORTED_MODULE_5__acl_config_js__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__promise_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__options_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__authorize_role_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__authorize_permission_js__ = __webpack_require__(18);
...
class VueAuthorize {
  constructor($auth, overrideOptions) {
    let options = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["a" /* objectExtend */])({}, __WEBPACK_IMPORTED_MODULE_2__options_js__["a" /* default */]);
    options = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["a" /* objectExtend */])(options, overrideOptions);
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["b" /* forEach */])(this.options.permissions, (handler, name) => {
      this.definePermission(name, handler);
    }, this);

    // Once permissions are done, define roles
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["b" /* forEach */])(this.options.roles, (handler, name) => {
      let rolePermissions = [];
      if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["c" /* isObject */])(handler)) {
  ...
  defineRole(name, handler, permissions) {
    ...
    if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["d" /* isFunction */])(handler)) {
      throw new Error('Role handler must be function');
    }

    let rolePermissions = [];
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["e" /* isArray */])(permissions)) {
    ...
    this.roles[name] = new __WEBPACK_IMPORTED_MODULE_3__authorize_role_js__["a" /* default */](name, handler, rolePermissions);
  }
  ...
  definePermission(name, handler) {
    ...
    this.permissions[name] = new __WEBPACK_IMPORTED_MODULE_4__authorize_permission_js__["a" /* default */](name, handler);
  }
  ...
  isAuthorized(role, permission) {
    let roleInstances = [];
    if (role) {
      if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["e" /* isArray */])(role)) {
        role = [role];
      }

      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["b" /* forEach */])(this.roles, (roleInstance, roleName) => {
        if (role.indexOf(roleInstance.name) >= 0) {
          roleInstances.push(roleInstance);
        }
      });
    } else {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["b" /* forEach */])(this.roles, roleInstance => {
        roleInstances.push(roleInstance);
      });
    }

    if (permission && !__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["e" /* isArray */])(permission)) {
    ...
    return new __WEBPACK_IMPORTED_MODULE_0__promise_js__["a" /* default */]((resolve, reject) => {
      ...
      return __WEBPACK_IMPORTED_MODULE_0__promise_js__["a" /* default */].any(roleInstances.map(roleInstance => {
        return roleInstance.invoke(permission, this);
      })).then(resolve).catch(reject);
    });
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = VueAuthorize;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__promise_js__ = __webpack_require__(3);
...
class Permission {
  constructor(name, handler) {
    ...
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_js__["d" /* isFunction */])(handler)) {
  ...
  invoke(context) {
    ...
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_js__["f" /* isPromise */])(invokeResult)) {
      return invokeResult;
    } else {
      return new __WEBPACK_IMPORTED_MODULE_1__promise_js__["a" /* default */](function (resolve, reject) {
        if (!!invokeResult) {
          resolve();
        } else {
          reject();
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Permission;
...
class Role {
  ...
  invoke(permission, context) {
    ...
    let invokeResult = this.handler.call(context || this);
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_js__["f" /* isPromise */])(invokeResult)) {
      if (permission) {
        if (permissionInstances) {
          // Permissions passed to check, run their invocation
          return invokeResult.then(() => {
            return __WEBPACK_IMPORTED_MODULE_0__promise_js__["a" /* default */].any(permissionInstances.map(permissionInstance => {
              return permissionInstance.invoke(context || this);
            })).then(() => {
              return __WEBPACK_IMPORTED_MODULE_0__promise_js__["a" /* default */].resolve();
            }, () => {
              return __WEBPACK_IMPORTED_MODULE_0__promise_js__["a" /* default */].reject();
            });
          });
        } else {
          __WEBPACK_IMPORTED_MODULE_0__promise_js__["a" /* default */].reject();
        }
      } else {
      ...
      return new __WEBPACK_IMPORTED_MODULE_0__promise_js__["a" /* default */](function (resolve, reject) {
        if (!!invokeResult) {
          if (permission) {
            if (permissionInstances) {
              return __WEBPACK_IMPORTED_MODULE_0__promise_js__["a" /* default */].any(permissionInstances.map(permissionInstance => {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__options_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__storage_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__oauth_oauth1_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__oauth_oauth2_js__ = __webpack_require__(30);
...
class VueAuthenticate {
  constructor($http, overrideOptions) {
    ...
    if (this.options.bindRequestInterceptor && __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_js__["b" /* isFunction */])(this.options.bindRequestInterceptor)) {
      this.options.bindRequestInterceptor.call(this)

      if (this.options.bindResponseInterceptor && __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_js__["b" /* isFunction */])(this.options.bindResponseInterceptor)) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__storage_local_storage_js__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__storage_memory_storage_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__storage_session_storage_js__ = __webpack_require__(35);
